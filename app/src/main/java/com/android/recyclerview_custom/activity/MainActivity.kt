package com.android.recyclerview_custom.activity
...
import com.android.recyclerview_custom.adapter.BlogPostAdapter
import com.android.recyclerview_custom.model.BlogPost

class MainActivity : AppCompatActivity() {
    private lateinit var listBlog: ArrayList<BlogPost>
    ...
    private fun initData() {
        listBlog = ArrayList()
        var rcvBlogPost = findViewById<RecyclerView>(R.id.recycler_view)
        rcvBlogPost.layoutManager = LinearLayoutManager(this)
        rcvBlogPost.setHasFixedSize(true)
//        rcvBlogPost.itemAnimator = DefaultItemAnimator()
//        rcvBlogPost.addItemDecoration(
//            DividerItemDecoration(
//                rcvBlogPost.context,
//                DividerItemDecoration.VERTICAL
//            )
//        )
        rcvBlogPost.adapter = BlogPostAdapter(listBlog, this)
